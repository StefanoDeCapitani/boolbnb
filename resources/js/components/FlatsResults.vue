<template>
  <div id="flats-results">
      ...
      <!-- sponsorizzati -->
      <div class="card_spacing" v-for="flat in activeFlats" :key='flat.id' >
        <div class="card flex-row">
          <img :src="flat.cover_img" class="card-img-top" alt="...">
          <div class="card-body d-inline">
            <span class="badge bg-warning text-dark my-1">In Evidenza</span>
            ...
            <div class="py-2">
              <span><span class="fa-solid fa-location-dot"></span> {{ flat.address }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- <div v-for="flat in notActiveFlats" :key='flat.id' >
        <div class="card" style="width: 18rem;">
          <img :src="flat.cover_img" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">{{flat.title}}</h5>
            <div v-for="service in flat.services" :key='service.id' > 
...
export default {
    ...
    computed:{
      ...
      notActiveFlats(){
        return this.flats.filter(flat=> flat.active_sponsorships.length === 0)
      }
    }
}
</script>
