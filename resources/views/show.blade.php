...
@section('content')
    <div>
        ...
        <div class="text-center">
            <img class="heroImg" src="{{ asset($flat->cover_img) }}" alt="">
        </div>
    </div>
            ...
            <div class="col-12 col-lg-10 ">
                ...
                <div class="row d-flex position-relative align-items-center  py-5">
                    ...
                    <div class="col-12 my-3 justify-content-center col-lg-4 text-center py-5 serviceItem">
                        <form class="pad-x" action="{{ route('flats.messages.store', $flat->slug) }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                                <h4>Invia Messaggio</h4>
                                <label for="name" class="form-label">Nome</label>
                                <input type="text " style=" border-radius: 15px" class="form-control" id="name"
                                    name="name" value="{{ old('name') }}" style="
                                        border-radius: 15px">
                                @error('name')
                                    {{ $message }}
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text " style=" border-radius: 15px" class="form-control" id="email"
                    ...
                    <div class="col-12 my-3 justify-content-center col-lg-7">
                        <img class="w-100" style="border-radius:25px" src="{{ asset($flat->cover_img) }}"
                            alt="">
                    </div>
                </div>
