...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@tomtom-international/web-sdk-services'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
form.addEventListener("submit", function (event) {
  ...
  !(function webpackMissingModule() { var e = new Error("Cannot find module '@tomtom-international/web-sdk-services'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).services.geocode({
