...
var canvasMonths = document.getElementById("analyticsPerMonth");
var messagesMonth = JSON.parse(canvasMonths.dataset.messages);
var viewsMonth = JSON.parse(canvasMonths.dataset.views);
var canvasYears = document.getElementById("analyticsPerYear");
var messagesYear = JSON.parse(canvasYears.dataset.messages);
var viewsYear = JSON.parse(canvasYears.dataset.views);

window.onload = function () {
  var ctxMonths = canvasMonths.getContext("2d");
  window.chartMonths = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctxMonths, {
    type: "line",
    data: {
      datasets: [{
        type: "line",
  ...
  window.chartYears = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](ctxYears, {
    type: "line",
    data: {
      datasets: [{
        type: "line",
...
__webpack_require__(/*! C:\Users\mauri\Documents\Boolean\Progetto finale\boolbnb\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\mauri\Documents\Boolean\Progetto finale\boolbnb\resources\sass\app.scss */"./resources/sass/app.scss");
